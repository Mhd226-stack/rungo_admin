   ...
   //public function store(Request $request)
    {
        ...
        $zoneType->zoneTypePrice()->create([
            ...
            'zone_a' => $request->zone_a_start_point.','.$request->zone_a_end_point.','.$request->zone_a_charge,
            'zone_b' => $request->zone_b_start_point.','.$request->zone_b_end_point.','.$request->zone_b_charge,
            'zone_c' => $request->zone_c_start_point.','.$request->zone_c_end_point.','.$request->zone_c_charge,
        ]);
