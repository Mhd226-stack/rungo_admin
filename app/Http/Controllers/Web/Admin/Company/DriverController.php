...
//                $query = Driver::whereOwnerId(auth()->user()->owner->id)->orderBy('created_at', 'desc');
                $query = Driver::whereOwnerId(auth()->user()->id)->orderBy('created_at', 'desc');
    ...
    */
    ...
    public function store(CreateDriverRequest $request)
    {
        ...
        $service_location_id = AdminDetail::where('user_id',auth()->user()->id)->select('service_location_id')->first()->service_location_id;
        $created_params['service_location_id'] = $service_location_id;
