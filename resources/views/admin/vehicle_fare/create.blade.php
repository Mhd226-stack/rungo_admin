    ...
    <div class="box box-solid box-info">
        ...
        <div class="box-body">
                ...
                <label for="base_distance">@lang('view_pages.select_base_distance')
                 ...
                 <input class="form-control" type="text" id="ride_now_base_distance" name="ride_now_base_distance" value="{{old('ride_now_base_distance')}}" required="" placeholder="@lang('view_pages.base_distance')">
    ...
    <div class="col-12">
        ...
        <div class="box-body">
                ...
                <label for="base_distance">@lang('view_pages.select_base_distance')
                 ...
                 <input class="form-control" type="text" id="ride_later_base_distance" name="ride_later_base_distance" value="{{old('ride_later_base_distance')}}" required="" placeholder="@lang('view_pages.base_distance')">
             ...
             <div class="box box-solid box-info">
                 ...
                 <div class="box-body">
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="base_price">@lang('view_pages.zone_a')&nbsp (@lang('view_pages.start_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_a_start_point" name="zone_a_start_point" value="{{old('zone_a_start_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.start_point')">
                                 <span class="text-danger">{{ $errors->first('zone_a_start_point') }}</span>
                         ...
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_a')&nbsp (@lang('view_pages.end_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_a_end_point" name="zone_a_end_point" value="{{old('zone_a_end_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.end_point')">
                                 <span class="text-danger">{{ $errors->first('zone_a_end_point') }}</span>

                             </div>
                         </div>
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_a')&nbsp (@lang('view_pages.charge')) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_a_charge" name="zone_a_charge" value="{{old('zone_a_charge')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.charge')">
                                 <span class="text-danger">{{ $errors->first('zone_a_charge') }}</span>
             ...
             <div class="box box-solid box-info">
                 ...
                 <div class="box-body">
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="base_price">@lang('view_pages.zone_b')&nbsp (@lang('view_pages.start_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_b_start_point" name="zone_b_start_point" value="{{old('zone_b_start_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.start_point')">
                                 <span class="text-danger">{{ $errors->first('zone_b_start_point') }}</span>
                         ...
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_b')&nbsp (@lang('view_pages.end_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_b_end_point" name="zone_b_end_point" value="{{old('zone_b_end_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.end_point')">
                                 <span class="text-danger">{{ $errors->first('zone_b_end_point') }}</span>

                             </div>
                         </div>
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_b')&nbsp (@lang('view_pages.charge')) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_b_charge" name="zone_b_charge" value="{{old('zone_b_charge')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.charge')">
                                 <span class="text-danger">{{ $errors->first('zone_b_charge') }}</span>
             ...
             <div class="box box-solid box-info">
                 ...
                 <div class="box-body">
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="base_price">@lang('view_pages.zone_c')&nbsp (@lang('view_pages.start_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_c_start_point" name="zone_c_start_point" value="{{old('zone_c_start_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.start_point')">
                                 <span class="text-danger">{{ $errors->first('zone_b_start_point') }}</span>
                         ...
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_c')&nbsp (@lang('view_pages.end_point')) (km) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_c_end_point" name="zone_c_end_point" value="{{old('zone_c_end_point')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.end_point')">
                                 <span class="text-danger">{{ $errors->first('zone_b_end_point') }}</span>
                         ...
                         <div class="col-sm-4">
                             <div class="form-group">
                                 <label for="price_per_distance">@lang('view_pages.zone_c')&nbsp (@lang('view_pages.charge')) <span class="text-danger">*</span></label>
                                 <input class="form-control" type="text" id="zone_c_charge" name="zone_c_charge" value="{{old('zone_c_charge')}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.charge')">
                                 <span class="text-danger">{{ $errors->first('zone_c_charge') }}</span>
