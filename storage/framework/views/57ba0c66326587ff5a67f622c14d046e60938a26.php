                        ...
                        <div class="row text-right">
                            ...
                            <div class="col-md-7 text-center text-md-right">
                                <button class="btn btn-outline btn-sm btn-danger py-2" type="button" data-toggle="modal"
                                   ...
                                   <?php echo app('translator')->get('view_pages.filter_requests'); ?>
                                </button>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/request/index.blade.php ENDPATH**/ ?>