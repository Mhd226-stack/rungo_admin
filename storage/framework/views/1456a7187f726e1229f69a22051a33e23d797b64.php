                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            ...
                            <?php echo e($total_drivers[0]['total']); ?></div><a class="font-weight-semi-bold fs--1 text-nowrap" href="<?php echo e(url('drivers')); ?>"><?php echo app('translator')->get('view_pages.see_all'); ?><span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>