                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <?php if(auth()->user()->can('add-sos')): ?>         

                                <a href="<?php echo e(url('sos/create')); ?>" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i><?php echo app('translator')->get('view_pages.add_sos'); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/sos/index.blade.php ENDPATH**/ ?>