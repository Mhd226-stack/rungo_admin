                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="<?php echo e(url('needed_doc/store')); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="account_type" id="account_type" class="form-control" required>
                                                ...
                                                <option value="individual" <?php echo e(old('account_type') == 'individual' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.individual'); ?></option>
                                                <option value="fleet_driver" <?php echo e(old('account_type') == 'fleet_driver' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.fleet_drivers'); ?></option>
                                                <option value="both" <?php echo e(old('both') == 'both' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.both'); ?></option>
                                            </select>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="has_expiry_date" id="has_expiry_date" class="form-control" required>
                                                <option value="" selected disabled><?php echo app('translator')->get('view_pages.select'); ?></option>
                                                <option value="1" <?php echo e(old('has_expiry_date') == '1' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.yes'); ?></option>
                                                <option value="0" <?php echo e(old('has_expiry_date') == '0' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.no'); ?></option>
                                            </select>
                                    ...
                                    <!-- <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="doc_type" id="doc_type" class="form-control" required>
                                                <option value="" selected disabled><?php echo app('translator')->get('view_pages.select'); ?></option>
                                                <?php $__currentLoopData = $format; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item); ?>" <?php echo e(old('doc_type') == $item ? 'selected' : ''); ?>><?php echo e(ucfirst($item)); ?></option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="has_identify_number" id="has_identify_number" class="form-control" required>
                                                <option value="" selected disabled><?php echo app('translator')->get('view_pages.select'); ?></option>
                                                <option value="1" <?php echo e(old('has_identify_number') == '1' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.yes'); ?></option>
                                                <option value="0" <?php echo e(old('has_identify_number') == '0' ? 'selected' : ''); ?>><?php echo app('translator')->get('view_pages.no'); ?></option>
                                            </select>
                                    ...
                                    <div class="col-sm-6 d-none" id="identify_number_div">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="identify_number_locale_key" name="identify_number_locale_key"
                                                value="<?php echo e(old('identify_number_locale_key')); ?>" 
...
<script>
    let hasIdentifyNumber = "<?php echo e(old('has_identify_number')); ?>";
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/master/needed_doc/create.blade.php ENDPATH**/ ?>