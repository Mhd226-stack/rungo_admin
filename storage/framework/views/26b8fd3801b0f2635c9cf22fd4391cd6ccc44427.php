            ...
            <div class="box-header with-border">
                <div class="row text-right">
                    ...
                    <div class="col-12 text-right">
                        <?php if(auth()->user()->can('add-promo')): ?>         

                                <a href="<?php echo e(url('promo/create')); ?>" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i><?php echo app('translator')->get('view_pages.add_promo'); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/promo/index.blade.php ENDPATH**/ ?>