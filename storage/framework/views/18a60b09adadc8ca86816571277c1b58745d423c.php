...
<div class="box">
    ...
    <div id="js-vehicle_fare-partial-target">
        <include-fragment src="fetch/<?php echo e($zone->id); ?>">
        ...
        <script>
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('fetch/'+"<?php echo e($zone->id); ?>"+'?search=' + search_keyword)
                ...
                $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('fetch/'+"<?php echo e($zone->id); ?>"+'?' + query)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-vehicle_fare-partial-target').innerHTML = html
                        });
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                fetch('fetch/'+"<?php echo e($zone->id); ?>"+'?search=' + search_keyword + '&' + query)
                                    .then(response => response.text())
                                    .then(html => {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/vehicle_fare/zoneIndex.blade.php ENDPATH**/ ?>