...
<head>
    ...
    <title><?php echo e(app_name() ?? 'Clust'); ?> - Admin App</title>
    ...
    <div class="wrapper skin-blue-light">
        ...
        <div class="content-wrapper">
            <section class="content">
                <div class="box">
                    <div class="box-body">
                        <p><?php echo app('translator')->get('view_pages.warning_text'); ?> <code>php artisan translation:export</code> <?php echo app('translator')->get('view_pages.command or publish button'); ?>.</p>
                        <div class="alert alert-success success-import" style="display:none;">
                            <p><?php echo app('translator')->get('view_pages.done_importing'); ?>,<?php echo app('translator')->get('view_pages.processed'); ?><strong class="counter">N</strong> <?php echo app('translator')->get('view_pages.items'); ?><?php echo app('translator')->get('view_pages.reload_this_page_to_refresh_the_groups'); ?></p>
                        </div>
                        <div class="alert alert-success success-find" style="display:none;">
                            <p><?php echo app('translator')->get('view_pages.done_searching_for_translations_found'); ?><strong class="counter">N</strong> <?php echo app('translator')->get('view_pages.items'); ?>!</p>
                        </div>
                        <div class="alert alert-success success-publish" style="display:none;">
                            <p><?php echo app('translator')->get('view_pages.done_publishing_the_translations_for_group'); ?>'<?php echo $group ?>'!</p>
                        </div>
                        <div class="alert alert-success success-publish-all" style="display:none;">
                            <p><?php echo app('translator')->get('view_pages.done_publishing_the_translations_for_all_group'); ?></p>
                        </div>
                        ...
                        <p>
                            <?php if (!isset($group)) : ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <select name="replace" class="form-control">
                                                    <option value="0"><?php echo app('translator')->get('view_pages.append_new_translation'); ?></option>
                                                    <option value="1"><?php echo app('translator')->get('view_pages.replace_existing_translations'); ?></option>
                                                </select>
                                            </div>
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-success btn-sm" data-disable-with="Loading.."><?php echo app('translator')->get('view_pages.import_groups'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <form class="form-find" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postFind') ?>" data-remote="true" role="form" data-confirm="Are you sure you want to scan you app folder? All found translation keys will be added to the database.">
                                    <div class="form-group">
                                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                        <button type="submit" class="btn btn-info btn-sm" data-disable-with="Searching.."><?php echo app('translator')->get('view_pages.find_translations_in_files'); ?></button>
                                    </div>
                                </form>
                            <?php endif; ?>
                            <?php if (isset($group)) : ?>
                                <form class="form-inline form-publish" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', $group) ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish the translations group '<?php echo $group ?>? This will overwrite existing language files.">
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                    <button type="submit" class="btn btn-info btn-sm mr-4" data-disable-with="Publishing.."><?php echo app('translator')->get('view_pages.publish_translations'); ?></button>
                                    <a href="<?= action('\Barryvdh\TranslationManager\Controller@getIndex') ?>" class="btn btn-danger btn-sm"><?php echo app('translator')->get('view_pages.back'); ?></a>
                                </form>
                            <?php endif; ?>
                        </p>
                        <form role="form" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddGroup') ?>">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <div class="form-group">
                                <p><?php echo app('translator')->get('view_pages.translation_text1'); ?>.</p>
                            ...
                            <div class="form-group">
                                <label><?php echo app('translator')->get('view_pages.translation_text2'); ?></label>
                        ...
                        <?php if ($group) : ?>
                            <form action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAdd', array($group)) ?>" method="POST" role="form">
                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                <div class="form-group">
                                    <label><?php echo app('translator')->get('view_pages.add_new_keys_to_this_group'); ?></label>
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <span class="btn btn-default btn-sm enable-auto-translate-group"><?php echo app('translator')->get('view_pages.use_auto_translate'); ?></span>
                                </div>
                            </div>
                            <form class="form-add-locale autotranslate-block-group hidden" method="POST" role="form" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postTranslateMissing') ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="base-locale"><?php echo app('translator')->get('view_pages.base_locale_for_auto_translations'); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="new-locale"><?php echo app('translator')->get('view_pages.enter_target_locale_key'); ?></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-default btn-sm" data-disable-with="Adding.."><?php echo app('translator')->get('view_pages.auto_translate_missing_translations'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <?php else : ?>
                            <fieldset>
                                <legend><?php echo app('translator')->get('view_pages.supported_locales'); ?></legend>
                                <p>
                                   <?php echo app('translator')->get('view_pages.current_supported_locales'); ?> :
                                </p>
                                ...
                                <form class="form-add-locale" method="POST" role="form" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddLocale') ?>">
                                    ...
                                    <div class="form-group">
                                        <p>
                                          <?php echo app('translator')->get('view_pages.enter_new_locale_key'); ?> :
                                        </p>
                                        <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-2">
                                                <button type="submit" class="btn btn-default btn-sm" data-disable-with="Adding.."> <?php echo app('translator')->get('view_pages.add_new_locale'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <fieldset>
                                <legend><?php echo app('translator')->get('view_pages.export_all_translations'); ?></legend>
                                <form class="form-inline form-publish-all" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', '*') ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish all translations group? This will overwrite existing language files.">
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                    <button type="submit" class="btn btn-primary btn-sm" data-disable-with="Publishing.."><?php echo app('translator')->get('view_pages.publish_all'); ?></button>
                                </form>
                            </fieldset>
...
<?php /**PATH C:\laragon\www\taxi\resources\views/vendor/translation-manager/index.blade.php ENDPATH**/ ?>