<table class="table table-hover">
    <thead>
        <tr>
            ...
            <th> <?php echo app('translator')->get('view_pages.account_type'); ?></th>
...
<tbody>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <?php if($result->account_type == 'fleet_driver'): ?>
            <td><?php echo app('translator')->get('view_pages.fleet_driver'); ?></td>
            <?php elseif($result->account_type == 'individual'): ?>
            <td><?php echo app('translator')->get('view_pages.individual'); ?></td>
            <?php else: ?>
            <td><?php echo app('translator')->get('view_pages.both'); ?></td>
            <?php endif; ?>            
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo app('translator')->get('view_pages.action'); ?>
                ...
                <?php if(auth()->user()->can('edit-driver-needed-document')): ?>         

                    <a class="dropdown-item" href="<?php echo e(url('needed_doc',$result->id)); ?>"><i class="fa fa-pencil"></i><?php echo app('translator')->get('view_pages.edit'); ?></a>
                <?php endif; ?>
                <?php if(auth()->user()->can('toggle-driver-needed-document')): ?>         
                    <?php if($result->active): ?>
                    <a class="dropdown-item" href="<?php echo e(url('needed_doc/toggle_status',$result->id)); ?>"><i class="fa fa-dot-circle-o"></i><?php echo app('translator')->get('view_pages.inactive'); ?></a>
                  
                    <?php else: ?>
                    <a class="dropdown-item" href="<?php echo e(url('needed_doc/toggle_status',$result->id)); ?>"><i class="fa fa-dot-circle-o"></i><?php echo app('translator')->get('view_pages.active'); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if(auth()->user()->can('delete-driver-needed-document')): ?>        
...
<?php /**PATH C:\laragon\www\taxi\resources\views/admin/master/needed_doc/_document.blade.php ENDPATH**/ ?>