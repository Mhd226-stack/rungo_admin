<table class="table table-hover">
    <thead>
        <tr>
            ...
            <th> <?php echo app('translator')->get('view_pages.question'); ?></th>
            <th> <?php echo app('translator')->get('view_pages.answer'); ?></th>
        ...
        <tr>
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo app('translator')->get('view_pages.action'); ?>
             ...
             <div class="dropdown-menu">
                <?php if(auth()->user()->can('edit-faq')): ?>
                    <a class="dropdown-item" href="<?php echo e(url('faq',$result->id)); ?>"><i class="fa fa-pencil"></i><?php echo app('translator')->get('view_pages.edit'); ?></a>
                <?php endif; ?>
                <?php if(auth()->user()->can('toggle-faq')): ?>

                    <?php if($result->active): ?>
                    <a class="dropdown-item" href="<?php echo e(url('faq/toggle_status',$result->id)); ?>"><i class="fa fa-dot-circle-o"></i><?php echo app('translator')->get('view_pages.inactive'); ?></a>
                    <?php else: ?>
                    <a class="dropdown-item" href="<?php echo e(url('faq/toggle_status',$result->id)); ?>"><i class="fa fa-dot-circle-o"></i><?php echo app('translator')->get('view_pages.active'); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
              <?php if(auth()->user()->can('delete-faq')): ?>
                    <a class="dropdown-item sweet-delete" href="<?php echo e(url('faq/delete',$result->id)); ?>"><i class="fa fa-trash-o"></i><?php echo app('translator')->get('view_pages.delete'); ?></a>
            <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\taxi\resources\views/admin/faq/_faq.blade.php ENDPATH**/ ?>