                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <?php if(auth()->user()->can('add-admin')): ?>         
                            
                            <div class="col-md-7 text-center text-md-right">
                                <a href="<?php echo e(url('admins/create')); ?>" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i><?php echo app('translator')->get('view_pages.add_admin'); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/admin/index.blade.php ENDPATH**/ ?>