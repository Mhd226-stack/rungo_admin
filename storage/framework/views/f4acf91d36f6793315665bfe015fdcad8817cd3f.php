<table class="table table-hover">
    <thead>
        <tr>
            ...
            <th> <?php echo app('translator')->get('view_pages.currency_symbol'); ?></th>
            <th> <?php echo app('translator')->get('view_pages.flag'); ?></th>
...
<tbody>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <td><?php echo e($result->currency_code); ?></td>
            <td><?php echo e($result->currency_symbol); ?></td>
            <td><img class="img-circle" src="<?php echo e(asset($result->flag)); ?>" alt=""></td>
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo app('translator')->get('view_pages.action'); ?>
                ...
                <?php if(auth()->user()->can('edit-country')): ?>         
                    <a class="dropdown-item" href="<?php echo e(url('country',$result->id)); ?>"><i class="fa fa-pencil"></i><?php echo app('translator')->get('view_pages.edit'); ?></a>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\taxi\resources\views/admin/master/country/_country.blade.php ENDPATH**/ ?>