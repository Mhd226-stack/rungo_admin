...
<script type="text/javascript">
    ...
    var pickLat = [];
    var pickLng = [];
    var default_lat = "<?php echo e(get_settings('default_latitude')); ?>";
    var default_lng = "<?php echo e(get_settings('default_longitude')); ?>";
        ...
        Object.entries(data).forEach(([key, val]) => {
            if (typeof val.l != 'undefined') {
                ...
                if (marker[key]) {
                    ...
                    marker[key].setPosition(new google.maps.LatLng(val.l[0], val.l[1]));
                } else {
                    // Create a new marker
                    var carIcon = new google.maps.Marker({
                        position: new google.maps.LatLng(val.l[0], val.l[1]),
                    ...
                    marker[key] = carIcon; // Store the marker in the dictionary
                }
            }
        });

        // Remove markers for drivers that are no longer in the data
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/map/map.blade.php ENDPATH**/ ?>