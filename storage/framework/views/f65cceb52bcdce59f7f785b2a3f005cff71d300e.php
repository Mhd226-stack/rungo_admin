            ...
            <div class="box-header with-border">
                <div class="row text-right">
                    ...
                    <div class="col-12 text-right">
                        <a href="<?php echo e(url('notifications/push/view')); ?>" class="btn btn-primary btn-sm">
                            <i class="mdi mdi-plus-circle mr-2"></i><?php echo app('translator')->get('view_pages.send_push'); ?></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/notification/push/index.blade.php ENDPATH**/ ?>