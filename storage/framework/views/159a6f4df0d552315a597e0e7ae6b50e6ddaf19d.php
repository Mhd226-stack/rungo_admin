                        ...
                        <div class="row text-right">
                            ...
                            <div class="col-5 col-md-1 text-left">
                                <button class="btn btn-outline btn-sm btn-danger py-2" type="button" data-toggle="modal"
                                    ...
                                    <?php echo app('translator')->get('view_pages.filter_drivers'); ?>
                                </button>
                            </div>
                                    ...
                                    <div class="modal-body text-left">
                                        <div class="driver-status">
                                            ...
                                            <div class="demo-radio-button">
                                                ...
                                                <label for="online">Available</label>
                                                <input name="available" type="radio" id="offline" data-val="0"
                                                    class="with-gap radio-col-grey">

                                                <label for="offline">On Ride</label>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\taxi\resources\views/admin/drivers/index.blade.php ENDPATH**/ ?>